        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div>
                <Badge className="mb-6 bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800 hover:from-blue-200 hover:to-blue-300 px-4 py-2 text-sm font-semibold">
                ...
                <p className="text-2xl text-blue-600 mb-6 font-semibold">Your health is our priority.</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 bg-transparent"
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-xl z-20">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-blue-600 font-bold">(555) 911-HELP</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <CardContent className="p-8 text-center">
                  <div className="bg-gradient-to-r from-blue-100 to-blue-200 p-4 rounded-2xl inline-block mb-6 text-blue-600">
                    {feature.icon}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-3 text-gray-300">
                ...
                <div className="hover:text-blue-400 transition-colors cursor-pointer">Health Tips</div>
              </div>
            </div>
